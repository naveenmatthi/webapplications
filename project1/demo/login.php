<?php
   ...
   if($_SERVER["REQUEST_METHOD"] == "POST") {
	  ...
	  echo($mypassword);
	  session_start();
	  $len=strlen($myusername);
	  $query=mysqli_query($db,"SELECT * FROM login WHERE username = '$myusername' AND password = '$mypassword'");
	  ...
	  {
		if(mysqli_num_rows($query)!=0 && $len >= 8)
		{ 
			$_SESSION["user"]=$myusername;
			echo $_SESSION["user"];
			header("Location:users/student/home.php");
		}
		else if(mysqli_num_rows($query)!=0 && $len > 5)
		{
			$_SESSION["user"]=$myusername;
			echo $_SESSION["user"];
			header("Location:users/faculty/index.html");
		}
		else
		{
		  	$_SESSION["user"]=$myusername;
  ...
  <section class="menu cid-ruOMQmoi9r" once="menu" id="menu1-z">
    <nav class="navbar navbar-expand beta-menu navbar-dropdown align-items-center navbar-fixed-top navbar-toggleable-sm">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
			...
			<!--<li class="nav-item"><a class="nav-link link text-black display-4" href="#">_________</a></li>-->
        ...
        <div class="media-container-row">
            <div class="col-md-3">
                <div class="media-wrap">
                    <a href="#">
                      </a><h2><a href="#"></a><a href="#">KL UNIVERSITY</a></h2>
